...
print(NEON_GREEN + "Loading knowledge base content..." + RESET_COLOR)
vault_content = []
if os.path.exists("Knowledge Base.txt"):
    with open("Knowledge Base.txt", "r", encoding='utf-8') as vault_file:
        vault_content = vault_file.readlines()

# Generate embeddings for the knowledge base content using Ollama
print(NEON_GREEN + "Generating embeddings for the knowledge base content..." + RESET_COLOR)
vault_embeddings = []
...
print("Embeddings for each line in the knowledge base:")
