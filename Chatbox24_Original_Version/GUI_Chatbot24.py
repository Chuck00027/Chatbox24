...
def create_main_gui():
    ...
    tk.Button(button_frame, text="Edit", width=15, command=lambda: run_script("GUI_load.py")).grid(row=0, column=0, padx=5)
    tk.Button(button_frame, text="Work", width=15, command=lambda: run_script("GUI_work.py")).grid(row=0, column=1, padx=5)
